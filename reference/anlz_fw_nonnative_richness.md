...
(0-100 percentile of area-normalized richness), and `outcome` (0-1, 1 =
best)

## Details

Counts unique `scientificName` values per bay segment/year, normalizes
by segment area (plus an AOI-wide `"All"` total normalized by total AOI
area, from
